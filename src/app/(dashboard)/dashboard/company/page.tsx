  ...
  const companyFeatures = [
    {
      ...
      icon: Briefcase,
      action: "View Jobs →",
      tourId: "page:company-home:jobs-card",
    },
    {
      ...
      icon: ClipboardList,
      action: "View Tasks →",
      tourId: "page:company-home:tasks-card",
    },
    {
      ...
      icon: Users,
      action: "View Mentors →",
      tourId: "page:company-home:mentors-card",
    },
    {
      ...
      tourId: "page:company-home:analytics-card",
    },
    {
